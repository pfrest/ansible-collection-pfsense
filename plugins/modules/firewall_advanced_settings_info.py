...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/advanced_settings."""
...
DOCUMENTATION = r"""
module: firewall_advanced_settings_info
description:
- Retrieve information about the Firewall Advanced Settings.
short_description: Retrieve information about the Firewall Advanced Settings.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve Firewall Advanced Settings
  pfrest.pfsense.firewall_advanced_settings_info:
...
def run_module():
    """Runs this info module against /api/v2/firewall/advanced_settings."""
    ...
    base_module = base.BaseModule("/api/v2/firewall/advanced_settings", client)
    changed = False
