...
###############################################################
"""An Ansible module for interacting with /api/v2/system/packages."""
...
DOCUMENTATION = r"""
module: system_packages_info
description:
- Retrieve information about many Packages.
short_description: Retrieve information about many Packages.
requirements:
...
- name: Retrieve all Packages
  pfrest.pfsense.system_packages_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Packages returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
    ...
    descr:
      ...
      returned: always
    installed_version:
      description: The version of the package currently installed.
      type: str
      returned: always
    latest_version:
      ...
      returned: always
    update_available:
      description: Indicates whether the installed package has an update available.
      type: bool
      returned: always
...
def run_module():
    """Runs this info module against /api/v2/system/packages."""
    ...
    base_module = base.BaseModule("/api/v2/system/packages", client)
    changed = False
