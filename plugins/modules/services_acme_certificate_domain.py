...
EXAMPLES = """
- name: Create ACME Certificate Domain
  pfrest.pfsense.services_acme_certificate_domain:
    ...
    name: string
    method: string
- name: Delete ACME Certificate Domain
  pfrest.pfsense.services_acme_certificate_domain:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
def run_module():
    """Runs this resource module against /api/v2/services/acme/certificate/domain."""
