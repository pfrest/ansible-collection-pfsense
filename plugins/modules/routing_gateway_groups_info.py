...
###############################################################
"""An Ansible module for interacting with /api/v2/routing/gateway/groups."""
...
DOCUMENTATION = r"""
module: routing_gateway_groups_info
description:
- Retrieve information about many Routing Gateway Groups.
short_description: Retrieve information about many Routing Gateway Groups.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all Routing Gateway Groups
  pfrest.pfsense.routing_gateway_groups_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Routing Gateway Groups returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/routing/gateway/groups."""
    ...
    base_module = base.BaseModule("/api/v2/routing/gateway/groups", client)
    changed = False
