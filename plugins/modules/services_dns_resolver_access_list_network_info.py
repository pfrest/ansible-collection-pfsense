...
DOCUMENTATION = r"""
module: services_dns_resolver_access_list_network_info
description:
...
EXAMPLES = """
- name: Retrieve DNS Resolver Access List Network
  pfrest.pfsense.services_dns_resolver_access_list_network_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/access_list/network."""
