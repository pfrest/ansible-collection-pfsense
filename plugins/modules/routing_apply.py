...
DOCUMENTATION = r"""
module: routing_apply
description:
- Perform the Routing Apply action.
short_description: Perform the Routing Apply action.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Perform Routing Apply action
  pfrest.pfsense.routing_apply:
...
def run_module():
    """Runs this action module against /api/v2/routing/apply."""
