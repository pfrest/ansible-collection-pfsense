...
###############################################################
"""An Ansible module for interacting with /api/v2/auth/keys."""
...
def run_module():
    """Runs this info module against /api/v2/auth/keys."""
    ...
    base_module = base.BaseModule("/api/v2/auth/keys", client)
    changed = False
