...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/backend/acls."""
...
DOCUMENTATION = r"""
module: services_haproxy_backend_acls_info
description:
- Retrieve information about many HAProxy Backend Access Control Lists.
short_description: Retrieve information about many HAProxy Backend Access Control
  Lists.
options:
  api_host:
    type: str
...
EXAMPLES = """
- name: Retrieve all HAProxy Backend Access Control Lists
  pfrest.pfsense.services_haproxy_backend_acls_info:
...
msg:
  ...
  returned: always
data:
  description: A list of HAProxy Backend Access Control Lists returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/backend/acls."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/backend/acls", client)
    changed = False
