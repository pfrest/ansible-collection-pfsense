...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_resolver/apply."""
...
DOCUMENTATION = r"""
module: services_dns_resolver_apply_info
description:
...
EXAMPLES = """
- name: Retrieve DNS Resolver Apply
  pfrest.pfsense.services_dns_resolver_apply_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/apply."""
    ...
    base_module = base.BaseModule("/api/v2/services/dns_resolver/apply", client)
    changed = False
