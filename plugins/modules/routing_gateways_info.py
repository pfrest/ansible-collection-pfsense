...
###############################################################
"""An Ansible module for interacting with /api/v2/routing/gateways."""
...
def run_module():
    """Runs this info module against /api/v2/routing/gateways."""
    ...
    base_module = base.BaseModule("/api/v2/routing/gateways", client)
    changed = False
