...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_forwarder/host_overrides."""
...
DOCUMENTATION = r"""
module: services_dns_forwarder_host_overrides_info
description:
- Retrieve information about many DNS Forwarder Host Overrides.
short_description: Retrieve information about many DNS Forwarder Host Overrides.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all DNS Forwarder Host Overrides
  pfrest.pfsense.services_dns_forwarder_host_overrides_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_forwarder/host_overrides."""
