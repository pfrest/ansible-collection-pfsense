...
DOCUMENTATION = r"""
module: firewall_states_size_info
description:
- Retrieve information about the Firewall States Size.
short_description: Retrieve information about the Firewall States Size.
requirements:
...
EXAMPLES = """
- name: Retrieve Firewall States Size
  pfrest.pfsense.firewall_states_size_info:
...
def run_module():
    """Runs this info module against /api/v2/firewall/states/size."""
