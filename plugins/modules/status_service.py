...
###############################################################
"""An Ansible module for interacting with /api/v2/status/service."""
...
def run_module():
    """Runs this action module against /api/v2/status/service."""
    ...
    base_module = base.BaseModule("/api/v2/status/service", client)
