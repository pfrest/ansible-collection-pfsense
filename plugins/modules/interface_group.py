...
description:
- Manage individual Interface Groups.
short_description: Manage individual Interface Groups.
options:
  api_host:
    type: str
    required: true
...
- name: Create Interface Group
  pfrest.pfsense.interface_group:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
    state: present
    ifname: string
- name: Delete Interface Group
  pfrest.pfsense.interface_group:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
def run_module():
    """Runs this resource module against /api/v2/interface/group."""
