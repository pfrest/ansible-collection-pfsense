...
DOCUMENTATION = r"""
module: firewall_traffic_shaper_limiter_info
description:
- Retrieve information about a single Traffic Shaper Limiter.
short_description: Retrieve information about a single Traffic Shaper Limiter.
requirements:
...
EXAMPLES = """
- name: Retrieve Traffic Shaper Limiter
  pfrest.pfsense.firewall_traffic_shaper_limiter_info:
...
msg:
  ...
  returned: always
data:
  description: The Traffic Shaper Limiter data returned by the API.
  type: dict
  returned: always
  contains:
    name:
...
def run_module():
    """Runs this info module against /api/v2/firewall/traffic_shaper/limiter."""
