...
DOCUMENTATION = r"""
module: routing_gateway_default
description:
...
options:
  ...
  defaultgw4:
    ...
    description: The gateway to assigns as the default IPv4 gateway for this system.
      Leave blank to automatically determine the default gateway, or set to `-` to
      assign no gateway.
  defaultgw6:
    required: false
    type: str
...
- name: Manage Default Gateway
  pfrest.pfsense.routing_gateway_default:
...
def run_module():
    """Runs this singleton module against /api/v2/routing/gateway/default."""
