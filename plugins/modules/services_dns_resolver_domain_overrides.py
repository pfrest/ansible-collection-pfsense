...
def run_module():
    module_args = {
        ...
        "objects": {
            ...
            "choices": [],
            "elements": "dict",
            "suboptions": {'domain': {'required': True, 'type': 'str', 'default': None, 'choices': [], 'description': 'The domain to override.'}, 'ip': {'required': True, 'type': 'str', 'default': None, 'choices': [], 'description': 'The IP address to which the domain should resolve.'}, 'descr': {'required': False, 'type': 'str', 'default': '', 'choices': [], 'description': 'The description for this domain override.'}, 'forward_tls_upstream': {'required': False, 'type': 'bool', 'default': False, 'choices': [], 'description': 'Enables or disables forwarding DNS queries to the upstream DNS server using TLS.'}, 'tls_hostname': {'required': False, 'type': 'str', 'default': '', 'choices': [], 'description': 'The hostname to use for the TLS connection to the upstream DNS server.'}},
        },
    }
