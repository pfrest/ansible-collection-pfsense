...
DOCUMENTATION = r"""
module: firewall_advanced_settings
description:
- Manage Firewall Advanced Settings.
short_description: Manage Firewall Advanced Settings.
requirements:
...
def run_module():
    """Runs this singleton module against /api/v2/firewall/advanced_settings."""
