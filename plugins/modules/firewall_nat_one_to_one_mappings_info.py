...
DOCUMENTATION = r"""
module: firewall_nat_one_to_one_mappings_info
description:
- Retrieve information about many 1:1 NAT mappings.
short_description: Retrieve information about many 1:1 NAT mappings.
options:
  api_host:
    type: str
    required: true
...
def run_module():
    """Runs this info module against /api/v2/firewall/nat/one_to_one/mappings."""
