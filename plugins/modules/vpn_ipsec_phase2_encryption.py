...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/ipsec/phase2/encryption."""
...
options:
  ...
  parent_lookup_fields:
    ...
    description: The list of fields to use when looking up the parent IPsec Phase
      2. This should be a list of field names that uniquely identify the parent object
...
data:
  ...
  contains:
    ...
    keylen:
      ...
      returned: always
    parent_id:
      description: The ID of the parent IPsec Phase 2 this resource is nested under.
      type: int
      returned: always
...
def run_module():
    """Runs this resource module against /api/v2/vpn/ipsec/phase2/encryption."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/ipsec/phase2/encryption", client)
