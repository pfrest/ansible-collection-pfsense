...
###############################################################
"""An Ansible module for interacting with /api/v2/status/logs/packages/restapi."""
...
DOCUMENTATION = r"""
module: status_logs_packages_restapi_info
description:
- Retrieve information about many RESTAPI Logs.
short_description: Retrieve information about many RESTAPI Logs.
requirements:
...
EXAMPLES = """
- name: Retrieve all RESTAPI Logs
  pfrest.pfsense.status_logs_packages_restapi_info:
...
msg:
  ...
  returned: always
data:
  description: A list of RESTAPI Logs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
    text:
      description: The raw text of the REST API log entry.
      type: str
      returned: always
...
def run_module():
    """Runs this info module against /api/v2/status/logs/packages/restapi."""
    ...
    base_module = base.BaseModule("/api/v2/status/logs/packages/restapi", client)
    changed = False
