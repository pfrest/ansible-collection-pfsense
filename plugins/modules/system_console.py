...
###############################################################
"""An Ansible module for interacting with /api/v2/system/console."""
...
DOCUMENTATION = r"""
module: system_console
description:
- Manage System Console.
short_description: Manage System Console.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Manage System Console
  pfrest.pfsense.system_console:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
    passwd_protect_console: false
...
def run_module():
    """Runs this singleton module against /api/v2/system/console."""
    ...
    base_module = base.BaseModule("/api/v2/system/console", client)
