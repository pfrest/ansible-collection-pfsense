...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/traffic_shaper/limiter/bandwidths."""
...
DOCUMENTATION = r"""
module: firewall_traffic_shaper_limiter_bandwidths_info
description:
- Retrieve information about many Traffic Shaper Limiter Bandwidths.
short_description: Retrieve information about many Traffic Shaper Limiter Bandwidths.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/firewall/traffic_shaper/limiter/bandwidths."""
    ...
    base_module = base.BaseModule(
        "/api/v2/firewall/traffic_shaper/limiter/bandwidths", client
    )
    changed = False
