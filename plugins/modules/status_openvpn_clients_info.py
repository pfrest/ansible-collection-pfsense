...
###############################################################
"""An Ansible module for interacting with /api/v2/status/openvpn/clients."""
...
def run_module():
    """Runs this info module against /api/v2/status/openvpn/clients."""
    ...
    base_module = base.BaseModule("/api/v2/status/openvpn/clients", client)
    changed = False
