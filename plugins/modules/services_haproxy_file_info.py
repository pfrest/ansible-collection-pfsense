...
description:
- Retrieve information about a single HAProxy File.
short_description: Retrieve information about a single HAProxy File.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/file."""
