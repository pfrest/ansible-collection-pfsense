...
###############################################################
"""An Ansible module for interacting with /api/v2/system/package/available."""
...
DOCUMENTATION = r"""
module: system_package_available_info
description:
- Retrieve information about many Available Packages.
short_description: Retrieve information about many Available Packages.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/system/package/available."""
    ...
    base_module = base.BaseModule("/api/v2/system/package/available", client)
    changed = False
