...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/openvpn/servers."""
...
def run_module():
    """Runs this info module against /api/v2/vpn/openvpn/servers."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/openvpn/servers", client)
    changed = False
