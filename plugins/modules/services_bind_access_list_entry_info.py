...
DOCUMENTATION = r"""
module: services_bind_access_list_entry_info
description:
- Retrieve information about a single BIND Access List Entry.
short_description: Retrieve information about a single BIND Access List Entry.
requirements:
...
EXAMPLES = """
- name: Retrieve BIND Access List Entry
  pfrest.pfsense.services_bind_access_list_entry_info:
...
def run_module():
    """Runs this info module against /api/v2/services/bind/access_list/entry."""
