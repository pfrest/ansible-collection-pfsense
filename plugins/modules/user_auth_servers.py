...
###############################################################
"""An Ansible module for interacting with /api/v2/user/auth_servers."""
...
DOCUMENTATION = r"""
module: user_auth_servers
description:
- Manage all authentication servers.
short_description: Manage all authentication servers.
requirements:
  ...
  objects:
    ...
    suboptions:
      ...
      ldap_protver:
        ...
        - 2
        - 3
        description: The LDAP protocol version to use for connections to this LDAP
      ...
      ldap_allow_unauthenticated:
        ...
        description: Enables or disables unauthenticated binding. Unauthenticated
          ...
          servers (Microsoft AD) allow this type of bind without any possibility to
          disable it.
      radius_secret:
        required: false
        type: str
      ...
      radius_nasip_attribute:
        ...
        description: The interface whose IP will be used as the 'NAS-IP-Address' attribute
          ...
          used for contacting the RADIUS server.
...
EXAMPLES = """
- name: Manage all authentication servers
  pfrest.pfsense.user_auth_servers:
...
msg:
  ...
  returned: always
data:
  description: A list of authentication servers returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this collection module against /api/v2/user/auth_servers."""
