...
description:
- Retrieve information about many HAProxy Frontends.
short_description: Retrieve information about many HAProxy Frontends.
requirements:
...
EXAMPLES = """
- name: Retrieve all HAProxy Frontends
