...
###############################################################
"""An Ansible module for interacting with /api/v2/status/openvpn/server/routes."""
...
DOCUMENTATION = r"""
module: status_openvpn_server_routes_info
description:
- Retrieve information about many OpenVPN Server Route Statuses.
short_description: Retrieve information about many OpenVPN Server Route Statuses.
requirements:
...
EXAMPLES = """
- name: Retrieve all OpenVPN Server Route Statuses
  pfrest.pfsense.status_openvpn_server_routes_info:
...
msg:
  ...
  returned: always
data:
  description: A list of OpenVPN Server Route Statuses returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/status/openvpn/server/routes."""
    ...
    base_module = base.BaseModule("/api/v2/status/openvpn/server/routes", client)
    changed = False
