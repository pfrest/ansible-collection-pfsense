...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/settings/email_mailers."""
...
DOCUMENTATION = r"""
module: services_haproxy_settings_email_mailers_info
description:
- Retrieve information about many HA Proxy Email Mailers.
short_description: Retrieve information about many HA Proxy Email Mailers.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all HA Proxy Email Mailers
  pfrest.pfsense.services_haproxy_settings_email_mailers_info:
...
msg:
  ...
  returned: always
data:
  description: A list of HA Proxy Email Mailers returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/settings/email_mailers."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/haproxy/settings/email_mailers", client
    )
    changed = False
