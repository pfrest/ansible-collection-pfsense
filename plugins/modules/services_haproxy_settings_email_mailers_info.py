...
description:
- Retrieve information about many HAProxy Email Mailers.
short_description: Retrieve information about many HAProxy Email Mailers.
requirements:
...
EXAMPLES = """
- name: Retrieve all HAProxy Email Mailers
...
msg:
  ...
  returned: always
data:
  description: A list of HAProxy Email Mailers returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
