...
DOCUMENTATION = r"""
module: services_dns_forwarder_host_override
description:
- Manage individual DNS Forwarder Host Overrides.
short_description: Manage individual DNS Forwarder Host Overrides.
options:
  api_host:
    type: str
    required: true
...
def run_module():
    """Runs this resource module against /api/v2/services/dns_forwarder/host_override."""
