...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/groups."""
...
EXAMPLES = """
- name: Retrieve all Interface Groups
  pfrest.pfsense.interface_groups_info:
...
def run_module():
    """Runs this info module against /api/v2/interface/groups."""
