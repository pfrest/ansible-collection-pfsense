...
DOCUMENTATION = r"""
module: system_crl_info
description:
- Retrieve information about a single Certificate Revocation List.
...
EXAMPLES = """
- name: Retrieve Certificate Revocation List
  pfrest.pfsense.system_crl_info:
...
msg:
  ...
  returned: always
data:
  description: The Certificate Revocation List data returned by the API.
  type: dict
  returned: always
  contains:
    refid:
...
def run_module():
    """Runs this info module against /api/v2/system/crl."""
