...
short_description: Manage individual Traffic Shaper Limiters.
requirements:
...
options:
  ...
  aqm:
    ...
    description: The Active Queue Management (AQM) algorithm to use for this limiter.
      AQM is the intelligent drop of network packets inside the limiter, when it becomes
  ...
  delay:
    ...
    default: null
    choices: []
    description: The amount of delay (in milliseconds) added to traffic passing through
      this limiter.
  plr:
    required: false
    type: float
