...
###############################################################
"""An Ansible module for interacting with /api/v2/routing/gateway/default."""
...
DOCUMENTATION = r"""
module: routing_gateway_default_info
description:
- Retrieve information about the Default Gateway.
short_description: Retrieve information about the Default Gateway.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/routing/gateway/default."""
    ...
    base_module = base.BaseModule("/api/v2/routing/gateway/default", client)
    changed = False
