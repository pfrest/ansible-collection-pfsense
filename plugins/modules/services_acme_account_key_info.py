...
###############################################################
"""An Ansible module for interacting with /api/v2/services/acme/account_key."""
...
DOCUMENTATION = r"""
module: services_acme_account_key_info
description:
- Retrieve information about a single ACME Account Key.
short_description: Retrieve information about a single ACME Account Key.
requirements:
...
EXAMPLES = """
- name: Retrieve ACME Account Key
  pfrest.pfsense.services_acme_account_key_info:
...
msg:
  ...
  returned: always
data:
  description: The ACME Account Key data returned by the API.
  type: dict
  returned: always
  contains:
    name:
...
def run_module():
    """Runs this info module against /api/v2/services/acme/account_key."""
    ...
    base_module = base.BaseModule("/api/v2/services/acme/account_key", client)
    changed = False
