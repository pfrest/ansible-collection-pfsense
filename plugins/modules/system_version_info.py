...
###############################################################
"""An Ansible module for interacting with /api/v2/system/version."""
...
def run_module():
    """Runs this info module against /api/v2/system/version."""
    ...
    base_module = base.BaseModule("/api/v2/system/version", client)
    changed = False
