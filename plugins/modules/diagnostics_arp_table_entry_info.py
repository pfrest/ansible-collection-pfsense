...
###############################################################
"""An Ansible module for interacting with /api/v2/diagnostics/arp_table/entry."""
...
DOCUMENTATION = r"""
module: diagnostics_arp_table_entry_info
description:
- Retrieve information about a single ARP Table Entry.
short_description: Retrieve information about a single ARP Table Entry.
requirements:
...
EXAMPLES = """
- name: Retrieve ARP Table Entry
  pfrest.pfsense.diagnostics_arp_table_entry_info:
...
msg:
  ...
  returned: always
data:
  description: The ARP Table Entry data returned by the API.
  type: dict
  returned: always
  contains:
    hostname:
...
def run_module():
    """Runs this info module against /api/v2/diagnostics/arp_table/entry."""
    ...
    base_module = base.BaseModule("/api/v2/diagnostics/arp_table/entry", client)
    changed = False
