...
description:
- Retrieve information about a single HAProxy Frontend.
short_description: Retrieve information about a single HAProxy Frontend.
requirements:
...
EXAMPLES = """
- name: Retrieve HAProxy Frontend
