...
DOCUMENTATION = r"""
module: services_ntp_time_servers_info
description:
- Retrieve information about many NTP Time Servers.
short_description: Retrieve information about many NTP Time Servers.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all NTP Time Servers
  pfrest.pfsense.services_ntp_time_servers_info:
...
def run_module():
    """Runs this info module against /api/v2/services/ntp/time_servers."""
