...
DOCUMENTATION = r"""
module: services_dhcp_server_address_pool_info
description:
- Retrieve information about a single DHCP Server Address Pool.
short_description: Retrieve information about a single DHCP Server Address Pool.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve DHCP Server Address Pool
  pfrest.pfsense.services_dhcp_server_address_pool_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dhcp_server/address_pool."""
