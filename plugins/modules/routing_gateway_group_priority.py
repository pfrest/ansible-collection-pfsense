...
DOCUMENTATION = r"""
module: routing_gateway_group_priority
description:
...
options:
  ...
  virtual_ip:
    ...
    default: address
    choices: []
    description: The virtual IP to use for this gateway group. Use `address` to use
      the interface's current IP.
author:
...
def run_module():
    """Runs this resource module against /api/v2/routing/gateway/group/priority."""
