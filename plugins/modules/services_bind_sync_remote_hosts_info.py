...
DOCUMENTATION = r"""
module: services_bind_sync_remote_hosts_info
description:
- Retrieve information about many BIND Sync Remote Hosts.
short_description: Retrieve information about many BIND Sync Remote Hosts.
requirements:
...
EXAMPLES = """
- name: Retrieve all BIND Sync Remote Hosts
  pfrest.pfsense.services_bind_sync_remote_hosts_info:
...
def run_module():
    """Runs this info module against /api/v2/services/bind/sync/remote_hosts."""
