...
def run_module():
    module_args = {
        ...
        "objects": {
            ...
            "required": True,
            "elements": "dict",
            "suboptions": {'name': {'required': True, 'type': 'str', 'default': None, 'choices': [], 'description': 'The name of the view.'}, 'descr': {'required': False, 'type': 'str', 'default': '', 'choices': [], 'description': 'A description for the view.'}, 'recursion': {'required': False, 'type': 'bool', 'default': False, 'choices': [], 'description': 'Enables or disables recursion for the view.'}, 'match_clients': {'required': False, 'type': 'list', 'default': [], 'choices': [], 'description': 'The access lists to match clients against.', 'elements': 'str'}, 'allow_recursion': {'required': False, 'type': 'list', 'default': [], 'choices': [], 'description': 'The access lists to allow recursion for.', 'elements': 'str'}, 'bind_custom_options': {'required': False, 'type': 'str', 'default': '', 'choices': [], 'description': 'Custom BIND options for the view.'}},
        },
    }
