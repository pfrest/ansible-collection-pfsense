...
description:
- Retrieve information about many HAProxy Frontend Actions.
short_description: Retrieve information about many HAProxy Frontend Actions.
requirements:
...
EXAMPLES = """
- name: Retrieve all HAProxy Frontend Actions
...
msg:
  ...
  returned: always
data:
  description: A list of HAProxy Frontend Actions returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
