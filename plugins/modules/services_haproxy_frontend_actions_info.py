...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/frontend/actions."""
...
DOCUMENTATION = r"""
module: services_haproxy_frontend_actions_info
description:
- Retrieve information about many HA Proxy Frontend Actions.
short_description: Retrieve information about many HA Proxy Frontend Actions.
requirements:
...
EXAMPLES = """
- name: Retrieve all HA Proxy Frontend Actions
  pfrest.pfsense.services_haproxy_frontend_actions_info:
...
msg:
  ...
  returned: always
data:
  description: A list of HA Proxy Frontend Actions returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/frontend/actions."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/frontend/actions", client)
    changed = False
