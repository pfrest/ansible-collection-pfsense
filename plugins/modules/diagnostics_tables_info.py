...
DOCUMENTATION = r"""
module: diagnostics_tables_info
description:
...
- name: Retrieve all Tables
  pfrest.pfsense.diagnostics_tables_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Tables returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/diagnostics/tables."""
    ...
    base_module = base.BaseModule("/api/v2/diagnostics/tables", client)
    changed = False
