...
def run_module():
    module_args = {
        ...
        "objects": {
            ...
            "required": True,
            "elements": "dict",
            "suboptions": {'name': {'required': True, 'type': 'str', 'default': None, 'choices': [], 'description': 'The name of this access list.'}, 'action': {'required': True, 'type': 'str', 'default': None, 'choices': ['allow', 'deny', 'refuse', 'allow snoop', 'deny nonlocal', 'refuse nonlocal'], 'description': 'The action to take when an access list match is found.'}, 'description': {'required': False, 'type': 'str', 'default': '', 'choices': [], 'description': 'A description for this access list.'}, 'networks': {'required': True, 'type': 'list', 'default': None, 'choices': [], 'description': 'The DNS Resolver access list network entries to include in this access list.'}},
        },
    }
