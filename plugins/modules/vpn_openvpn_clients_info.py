...
description:
- Retrieve information about many OpenVPN Clients.
short_description: Retrieve information about many OpenVPN Clients.
requirements:
...
EXAMPLES = """
- name: Retrieve all OpenVPN Clients
...
msg:
  ...
  returned: always
data:
  description: A list of OpenVPN Clients returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
