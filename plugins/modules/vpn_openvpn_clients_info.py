...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/openvpn/clients."""
...
DOCUMENTATION = r"""
module: vpn_openvpn_clients_info
description:
- Retrieve information about many Open VPN Clients.
short_description: Retrieve information about many Open VPN Clients.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all Open VPN Clients
  pfrest.pfsense.vpn_openvpn_clients_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Open VPN Clients returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/vpn/openvpn/clients."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/openvpn/clients", client)
    changed = False
