...
DOCUMENTATION = r"""
module: vpn_wireguard_settings_info
description:
- Retrieve information about the WireGuard Settings.
short_description: Retrieve information about the WireGuard Settings.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve WireGuard Settings
  pfrest.pfsense.vpn_wireguard_settings_info:
...
def run_module():
    """Runs this info module against /api/v2/vpn/wireguard/settings."""
