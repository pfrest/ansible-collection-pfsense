...
###############################################################
"""An Ansible module for interacting with /api/v2/routing/static_routes."""
...
def run_module():
    """Runs this info module against /api/v2/routing/static_routes."""
    ...
    base_module = base.BaseModule("/api/v2/routing/static_routes", client)
    changed = False
