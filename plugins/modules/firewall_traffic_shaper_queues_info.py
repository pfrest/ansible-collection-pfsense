...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/traffic_shaper/queues."""
...
DOCUMENTATION = r"""
module: firewall_traffic_shaper_queues_info
description:
...
EXAMPLES = """
- name: Retrieve all Traffic Shaper Queues
  pfrest.pfsense.firewall_traffic_shaper_queues_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Traffic Shaper Queues returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/firewall/traffic_shaper/queues."""
    ...
    base_module = base.BaseModule("/api/v2/firewall/traffic_shaper/queues", client)
    changed = False
