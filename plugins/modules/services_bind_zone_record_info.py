...
DOCUMENTATION = r"""
module: services_bind_zone_record_info
description:
- Retrieve information about a single BIND Zone Record.
short_description: Retrieve information about a single BIND Zone Record.
options:
  api_host:
    type: str
    required: true
...
def run_module():
    """Runs this info module against /api/v2/services/bind/zone/record."""
