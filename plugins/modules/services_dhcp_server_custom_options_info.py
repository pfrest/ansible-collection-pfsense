...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dhcp_server/custom_options."""
...
DOCUMENTATION = r"""
module: services_dhcp_server_custom_options_info
description:
- Retrieve information about many DHCP Server Custom Options.
short_description: Retrieve information about many DHCP Server Custom Options.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/services/dhcp_server/custom_options."""
    ...
    base_module = base.BaseModule("/api/v2/services/dhcp_server/custom_options", client)
    changed = False
