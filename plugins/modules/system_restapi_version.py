...
###############################################################
"""An Ansible module for interacting with /api/v2/system/restapi/version."""
...
options:
  ...
  install_version:
    ...
    default: null
    choices: []
    description: Set the API version to update or rollback to.
author:
...
EXAMPLES = """
- name: Manage REST API Version
  pfrest.pfsense.system_restapi_version:
...
def run_module():
    """Runs this singleton module against /api/v2/system/restapi/version."""
    ...
    base_module = base.BaseModule("/api/v2/system/restapi/version", client)
