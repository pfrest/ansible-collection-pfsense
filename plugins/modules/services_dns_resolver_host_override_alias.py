...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_resolver/host_override/alias."""
...
DOCUMENTATION = r"""
module: services_dns_resolver_host_override_alias
description:
- Manage individual DNS Resolver Host Override Aliases.
short_description: Manage individual DNS Resolver Host Override Aliases.
options:
  api_host:
    type: str
    required: true
  ...
  parent_lookup_query:
    type: dict
    required: true
    description: A dictionary of query parameters used to look up the parent DNS Resolver
...
EXAMPLES = """
- name: Create DNS Resolver Host Override Alias
  pfrest.pfsense.services_dns_resolver_host_override_alias:
    ...
    host: string
    domain: string
- name: Delete DNS Resolver Host Override Alias
  pfrest.pfsense.services_dns_resolver_host_override_alias:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
data:
  ...
  contains:
    ...
    descr:
      ...
      returned: always
    parent_id:
      description: The ID of the parent DNS Resolver Host Override this resource is
        nested under.
      type: int
      returned: always
...
def run_module():
    """Runs this resource module against /api/v2/services/dns_resolver/host_override/alias."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/dns_resolver/host_override/alias", client
    )
