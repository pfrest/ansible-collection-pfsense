...
###############################################################
"""An Ansible module for interacting with /api/v2/services/bind/access_list/entries."""
...
DOCUMENTATION = r"""
module: services_bind_access_list_entries_info
description:
- Retrieve information about many BIND Access List Entries.
short_description: Retrieve information about many BIND Access List Entries.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all BIND Access List Entries
  pfrest.pfsense.services_bind_access_list_entries_info:
...
msg:
  ...
  returned: always
data:
  description: A list of BIND Access List Entries returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/bind/access_list/entries."""
    ...
    base_module = base.BaseModule("/api/v2/services/bind/access_list/entries", client)
    changed = False
