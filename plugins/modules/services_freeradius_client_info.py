...
description:
- Retrieve information about a single FreeRADIUS Client.
short_description: Retrieve information about a single FreeRADIUS Client.
requirements:
...
EXAMPLES = """
- name: Retrieve FreeRADIUS Client
