...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/bridge."""
...
DOCUMENTATION = r"""
module: interface_bridge_info
description:
- Retrieve information about a single Interface Bridge.
short_description: Retrieve information about a single Interface Bridge.
requirements:
...
EXAMPLES = """
- name: Retrieve Interface Bridge
  pfrest.pfsense.interface_bridge_info:
...
msg:
  ...
  returned: always
data:
  description: The Interface Bridge data returned by the API.
  type: dict
  returned: always
  contains:
    members:
...
def run_module():
    """Runs this info module against /api/v2/interface/bridge."""
    ...
    base_module = base.BaseModule("/api/v2/interface/bridge", client)
    changed = False
