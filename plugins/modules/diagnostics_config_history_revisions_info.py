...
###############################################################
"""An Ansible module for interacting with /api/v2/diagnostics/config_history/revisions."""
...
DOCUMENTATION = r"""
module: diagnostics_config_history_revisions_info
description:
...
EXAMPLES = """
- name: Retrieve all Configuration History Entries
  pfrest.pfsense.diagnostics_config_history_revisions_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Configuration History Entries returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/diagnostics/config_history/revisions."""
    ...
    base_module = base.BaseModule(
        "/api/v2/diagnostics/config_history/revisions", client
    )
    changed = False
