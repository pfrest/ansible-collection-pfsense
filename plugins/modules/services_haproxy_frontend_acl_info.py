...
DOCUMENTATION = r"""
module: services_haproxy_frontend_acl_info
description:
- Retrieve information about a single HAProxy Frontend Access Control List.
short_description: Retrieve information about a single HAProxy Frontend Access Control
  List.
requirements:
...
EXAMPLES = """
- name: Retrieve HAProxy Frontend Access Control List
  pfrest.pfsense.services_haproxy_frontend_acl_info:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/frontend/acl."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/frontend/acl", client)
    changed = False
