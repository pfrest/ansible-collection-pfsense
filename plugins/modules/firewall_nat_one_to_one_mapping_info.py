...
DOCUMENTATION = r"""
module: firewall_nat_one_to_one_mapping_info
description:
- Retrieve information about a single 1:1 NAT mapping.
short_description: Retrieve information about a single 1:1 NAT mapping.
requirements:
...
EXAMPLES = """
- name: Retrieve 1:1 NAT mapping
  pfrest.pfsense.firewall_nat_one_to_one_mapping_info:
...
def run_module():
    """Runs this info module against /api/v2/firewall/nat/one_to_one/mapping."""
