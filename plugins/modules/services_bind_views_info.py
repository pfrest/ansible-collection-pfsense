...
DOCUMENTATION = r"""
module: services_bind_views_info
description:
- Retrieve information about many BIND Views.
short_description: Retrieve information about many BIND Views.
requirements:
...
EXAMPLES = """
- name: Retrieve all BIND Views
  pfrest.pfsense.services_bind_views_info:
...
def run_module():
    """Runs this info module against /api/v2/services/bind/views."""
