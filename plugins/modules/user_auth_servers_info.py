...
DOCUMENTATION = r"""
module: user_auth_servers_info
description:
- Retrieve information about many authentication servers.
short_description: Retrieve information about many authentication servers.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all authentication servers
  pfrest.pfsense.user_auth_servers_info:
...
def run_module():
    """Runs this info module against /api/v2/user/auth_servers."""
