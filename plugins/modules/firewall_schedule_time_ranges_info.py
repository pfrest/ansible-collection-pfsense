...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/schedule/time_ranges."""
...
DOCUMENTATION = r"""
module: firewall_schedule_time_ranges_info
description:
- Retrieve information about many Firewall Schedule Time Ranges.
short_description: Retrieve information about many Firewall Schedule Time Ranges.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all Firewall Schedule Time Ranges
  pfrest.pfsense.firewall_schedule_time_ranges_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Firewall Schedule Time Ranges returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/firewall/schedule/time_ranges."""
    ...
    base_module = base.BaseModule("/api/v2/firewall/schedule/time_ranges", client)
    changed = False
