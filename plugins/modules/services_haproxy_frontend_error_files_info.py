...
description:
- Retrieve information about many HAProxy Frontend Error Files.
short_description: Retrieve information about many HAProxy Frontend Error Files.
requirements:
...
EXAMPLES = """
- name: Retrieve all HAProxy Frontend Error Files
...
msg:
  ...
  returned: always
data:
  description: A list of HAProxy Frontend Error Files returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
