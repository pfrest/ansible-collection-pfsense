...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/frontend/error_files."""
...
DOCUMENTATION = r"""
module: services_haproxy_frontend_error_files_info
description:
- Retrieve information about many HA Proxy Frontend Error Files.
short_description: Retrieve information about many HA Proxy Frontend Error Files.
requirements:
...
EXAMPLES = """
- name: Retrieve all HA Proxy Frontend Error Files
  pfrest.pfsense.services_haproxy_frontend_error_files_info:
...
msg:
  ...
  returned: always
data:
  description: A list of HA Proxy Frontend Error Files returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/frontend/error_files."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/haproxy/frontend/error_files", client
    )
    changed = False
