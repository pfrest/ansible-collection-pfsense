...
###############################################################
"""An Ansible module for interacting with /api/v2/user/groups."""
...
EXAMPLES = """
- name: Retrieve all User Groups
  pfrest.pfsense.user_groups_info:
...
def run_module():
    """Runs this info module against /api/v2/user/groups."""
