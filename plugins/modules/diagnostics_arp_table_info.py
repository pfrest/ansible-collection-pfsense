...
###############################################################
"""An Ansible module for interacting with /api/v2/diagnostics/arp_table."""
...
def run_module():
    """Runs this info module against /api/v2/diagnostics/arp_table."""
    ...
    base_module = base.BaseModule("/api/v2/diagnostics/arp_table", client)
    changed = False
