...
DOCUMENTATION = r"""
module: services_acme_certificates_info
description:
...
EXAMPLES = """
- name: Retrieve all ACME Certificates
  pfrest.pfsense.services_acme_certificates_info:
...
msg:
  ...
  returned: always
data:
  description: A list of ACME Certificates returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/acme/certificates."""
