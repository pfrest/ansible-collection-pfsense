...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_resolver/access_list/networks."""
...
DOCUMENTATION = r"""
module: services_dns_resolver_access_list_networks_info
description:
- Retrieve information about many DNS Resolver Access List Networks.
short_description: Retrieve information about many DNS Resolver Access List Networks.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all DNS Resolver Access List Networks
  pfrest.pfsense.services_dns_resolver_access_list_networks_info:
...
msg:
  ...
  returned: always
data:
  description: A list of DNS Resolver Access List Networks returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/access_list/networks."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/dns_resolver/access_list/networks", client
    )
    changed = False
