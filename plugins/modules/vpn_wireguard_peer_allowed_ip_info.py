...
DOCUMENTATION = r"""
module: vpn_wireguard_peer_allowed_ip_info
description:
- Retrieve information about a single WireGuard Peer Allowed IP.
short_description: Retrieve information about a single WireGuard Peer Allowed IP.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve WireGuard Peer Allowed IP
  pfrest.pfsense.vpn_wireguard_peer_allowed_ip_info:
...
def run_module():
    """Runs this info module against /api/v2/vpn/wireguard/peer/allowed_ip."""
