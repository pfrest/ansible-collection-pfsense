...
DOCUMENTATION = r"""
module: services_acme_account_key
description:
...
- name: Create ACME Account Key
  pfrest.pfsense.services_acme_account_key:
...
def run_module():
    """Runs this resource module against /api/v2/services/acme/account_key."""
