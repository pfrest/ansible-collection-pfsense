...
DOCUMENTATION = r"""
module: services_service_watchdog_info
description:
- Retrieve information about a single Service Watchdog.
short_description: Retrieve information about a single Service Watchdog.
options:
  api_host:
    type: str
    required: true
...
def run_module():
    """Runs this info module against /api/v2/services/service_watchdog."""
