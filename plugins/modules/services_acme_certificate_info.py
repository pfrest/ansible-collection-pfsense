...
DOCUMENTATION = r"""
module: services_acme_certificate_info
description:
- Retrieve information about a single ACME Certificate.
short_description: Retrieve information about a single ACME Certificate.
options:
  api_host:
    type: str
    required: true
...
- name: Retrieve ACME Certificate
  pfrest.pfsense.services_acme_certificate_info:
...
def run_module():
    """Runs this info module against /api/v2/services/acme/certificate."""
