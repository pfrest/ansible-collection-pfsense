...
description:
- Retrieve information about many FreeRADIUS Clients.
short_description: Retrieve information about many FreeRADIUS Clients.
requirements:
...
EXAMPLES = """
- name: Retrieve all FreeRADIUS Clients
