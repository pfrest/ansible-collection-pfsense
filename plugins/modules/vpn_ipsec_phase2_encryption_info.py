...
DOCUMENTATION = r"""
module: vpn_ipsec_phase2_encryption_info
description:
...
EXAMPLES = """
- name: Retrieve IPsec Phase 2 Encryption
  pfrest.pfsense.vpn_ipsec_phase2_encryption_info:
...
def run_module():
    """Runs this info module against /api/v2/vpn/ipsec/phase2/encryption."""
