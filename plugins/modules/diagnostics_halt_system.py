...
###############################################################
"""An Ansible module for interacting with /api/v2/diagnostics/halt_system."""
...
DOCUMENTATION = r"""
module: diagnostics_halt_system
description:
...
options:
  ...
  dry_run:
    ...
    default: false
    choices: []
    description: Run through the call but don't actually initiate a shutdown.
author:
...
EXAMPLES = """
- name: Perform System Halt action
  pfrest.pfsense.diagnostics_halt_system:
...
msg:
  ...
  returned: always
data:
  description: The System Halt data returned by the API.
  type: dict
  returned: always
...
def run_module():
    """Runs this action module against /api/v2/diagnostics/halt_system."""
    ...
    base_module = base.BaseModule("/api/v2/diagnostics/halt_system", client)
