...
###############################################################
"""An Ansible module for interacting with /api/v2/system/crls."""
...
def run_module():
    """Runs this info module against /api/v2/system/crls."""
    ...
    base_module = base.BaseModule("/api/v2/system/crls", client)
    changed = False
