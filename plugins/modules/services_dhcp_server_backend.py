...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dhcp_server/backend."""
...
DOCUMENTATION = r"""
module: services_dhcp_server_backend
description:
- Manage DHCP Server Backend.
short_description: Manage DHCP Server Backend.
requirements:
...
def run_module():
    """Runs this singleton module against /api/v2/services/dhcp_server/backend."""
    ...
    base_module = base.BaseModule("/api/v2/services/dhcp_server/backend", client)
