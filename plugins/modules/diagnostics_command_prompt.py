...
###############################################################
"""An Ansible module for interacting with /api/v2/diagnostics/command_prompt."""
...
DOCUMENTATION = r"""
module: diagnostics_command_prompt
description:
...
def run_module():
    """Runs this action module against /api/v2/diagnostics/command_prompt."""
    ...
    base_module = base.BaseModule("/api/v2/diagnostics/command_prompt", client)
