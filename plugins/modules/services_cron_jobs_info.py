...
DOCUMENTATION = r"""
module: services_cron_jobs_info
description:
- Retrieve information about many Cron Jobs.
short_description: Retrieve information about many Cron Jobs.
requirements:
...
EXAMPLES = """
- name: Retrieve all Cron Jobs
  pfrest.pfsense.services_cron_jobs_info:
...
def run_module():
    """Runs this info module against /api/v2/services/cron/jobs."""
