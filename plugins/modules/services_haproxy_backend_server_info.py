...
description:
- Retrieve information about a single HAProxy Backend Server.
short_description: Retrieve information about a single HAProxy Backend Server.
requirements:
...
EXAMPLES = """
- name: Retrieve HAProxy Backend Server
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/backend/server."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/backend/server", client)
    changed = False
