...
DOCUMENTATION = r"""
module: services_freeradius_macs_info
description:
- Retrieve information about many FreeRADIUS MACs.
short_description: Retrieve information about many FreeRADIUS MACs.
requirements:
...
EXAMPLES = """
- name: Retrieve all FreeRADIUS MACs
  pfrest.pfsense.services_freeradius_macs_info:
...
def run_module():
    """Runs this info module against /api/v2/services/freeradius/macs."""
