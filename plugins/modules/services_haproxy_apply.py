...
data:
  ...
  contains:
    applied:
      description: Indicates whether all HAProxy configuration changes have been applied.
      type: bool
      returned: always
...
def run_module():
    """Runs this action module against /api/v2/services/haproxy/apply."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/apply", client)
