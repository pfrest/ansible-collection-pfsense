...
DOCUMENTATION = r"""
module: firewall_nat_outbound_mode_info
description:
- Retrieve information about the Outbound NAT Mode.
short_description: Retrieve information about the Outbound NAT Mode.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/firewall/nat/outbound/mode."""
