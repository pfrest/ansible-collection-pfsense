...
DOCUMENTATION = '''
module: services_bind_access_lists
description:
...
EXAMPLES = '''
- name: Manage all BIND Access Lists
  pfrest.pfsense.services_bind_access_lists:
...
def run_module():
    module_args = {
        ...
        "objects": {
            ...
            "required": True,
            "elements": "dict",
            "suboptions": {'name': {'required': True, 'type': 'str', 'default': None, 'choices': [], 'description': 'The name of the access list.'}, 'description': {'required': False, 'type': 'str', 'default': '', 'choices': [], 'description': 'A description for the access list.'}, 'entries': {'required': True, 'type': 'list', 'default': None, 'choices': [], 'description': 'The network entries for this access list.'}},
        },
    }
