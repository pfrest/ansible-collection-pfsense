...
###############################################################
"""An Ansible module for interacting with /api/v2/status/openvpn/server/connections."""
...
def run_module():
    """Runs this info module against /api/v2/status/openvpn/server/connections."""
    ...
    base_module = base.BaseModule("/api/v2/status/openvpn/server/connections", client)
    changed = False
