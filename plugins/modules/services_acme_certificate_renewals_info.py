...
###############################################################
"""An Ansible module for interacting with /api/v2/services/acme/certificate/renewals."""
...
DOCUMENTATION = r"""
module: services_acme_certificate_renewals_info
description:
- Retrieve information about many ACME Certificate Renewals.
short_description: Retrieve information about many ACME Certificate Renewals.
requirements:
...
EXAMPLES = """
- name: Retrieve all ACME Certificate Renewals
...
msg:
  ...
  returned: always
data:
  description: A list of ACME Certificate Renewals returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/acme/certificate/renewals."""
    ...
    base_module = base.BaseModule("/api/v2/services/acme/certificate/renewals", client)
    changed = False
