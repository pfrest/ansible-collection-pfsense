...
###############################################################
"""An Ansible module for interacting with /api/v2/system/hostname."""
...
DOCUMENTATION = r"""
module: system_hostname_info
description:
- Retrieve information about the System Hostname.
short_description: Retrieve information about the System Hostname.
requirements:
...
- name: Retrieve System Hostname
  pfrest.pfsense.system_hostname_info:
...
msg:
  ...
  returned: always
data:
  description: The System Hostname data returned by the API.
  type: dict
  returned: always
  contains:
    hostname:
...
def run_module():
    """Runs this info module against /api/v2/system/hostname."""
    ...
    base_module = base.BaseModule("/api/v2/system/hostname", client)
    changed = False
