...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_forwarder/host_override."""
...
DOCUMENTATION = r"""
module: services_dns_forwarder_host_override_info
description:
- Retrieve information about a single DNS Forwarder Host Override.
...
EXAMPLES = """
- name: Retrieve DNS Forwarder Host Override
  pfrest.pfsense.services_dns_forwarder_host_override_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_forwarder/host_override."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/dns_forwarder/host_override", client
    )
    changed = False
