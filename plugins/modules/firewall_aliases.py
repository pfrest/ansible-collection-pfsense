...
DOCUMENTATION = r"""
module: firewall_aliases
description:
- Manage all Firewall Aliases.
short_description: Manage all Firewall Aliases.
options:
  api_host:
    type: str
    required: true
  ...
  objects:
    ...
    suboptions:
      ...
      descr:
        ...
        default: ''
        choices: []
        description: Sets a description to help specify the purpose or contents of
          the alias.
      address:
        required: false
        type: list
...
EXAMPLES = """
- name: Manage all Firewall Aliases
  pfrest.pfsense.firewall_aliases:
...
def run_module():
    """Runs this collection module against /api/v2/firewall/aliases."""
