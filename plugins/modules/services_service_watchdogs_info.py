...
###############################################################
"""An Ansible module for interacting with /api/v2/services/service_watchdogs."""
...
DOCUMENTATION = r"""
module: services_service_watchdogs_info
description:
...
EXAMPLES = """
- name: Retrieve all Service Watchdogs
  pfrest.pfsense.services_service_watchdogs_info:
...
def run_module():
    """Runs this info module against /api/v2/services/service_watchdogs."""
