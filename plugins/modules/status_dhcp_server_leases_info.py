...
###############################################################
"""An Ansible module for interacting with /api/v2/status/dhcp_server/leases."""
...
DOCUMENTATION = r"""
module: status_dhcp_server_leases_info
description:
- Retrieve information about many DHCP Server Leases.
short_description: Retrieve information about many DHCP Server Leases.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/status/dhcp_server/leases."""
    ...
    base_module = base.BaseModule("/api/v2/status/dhcp_server/leases", client)
    changed = False
