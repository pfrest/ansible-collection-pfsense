...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/state."""
...
EXAMPLES = """
- name: Retrieve Firewall State
  pfrest.pfsense.firewall_state_info:
...
msg:
  ...
  returned: always
data:
  description: The Firewall State data returned by the API.
  type: dict
  returned: always
  contains:
    interface:
...
def run_module():
    """Runs this info module against /api/v2/firewall/state."""
    ...
    base_module = base.BaseModule("/api/v2/firewall/state", client)
    changed = False
