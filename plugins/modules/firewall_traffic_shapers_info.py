...
DOCUMENTATION = r"""
module: firewall_traffic_shapers_info
description:
- Retrieve information about many Traffic Shapers.
short_description: Retrieve information about many Traffic Shapers.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all Traffic Shapers
  pfrest.pfsense.firewall_traffic_shapers_info:
...
def run_module():
    """Runs this info module against /api/v2/firewall/traffic_shapers."""
