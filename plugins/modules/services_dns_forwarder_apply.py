...
DOCUMENTATION = r"""
module: services_dns_forwarder_apply
description:
...
EXAMPLES = """
- name: Perform DNS Forwarder Apply action
  pfrest.pfsense.services_dns_forwarder_apply:
...
def run_module():
    """Runs this action module against /api/v2/services/dns_forwarder/apply."""
