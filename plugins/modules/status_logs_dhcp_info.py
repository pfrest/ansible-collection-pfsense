...
###############################################################
"""An Ansible module for interacting with /api/v2/status/logs/dhcp."""
...
DOCUMENTATION = r"""
module: status_logs_dhcp_info
description:
- Retrieve information about many DHCP Logs.
short_description: Retrieve information about many DHCP Logs.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all DHCP Logs
  pfrest.pfsense.status_logs_dhcp_info:
...
msg:
  ...
  returned: always
data:
  description: A list of DHCP Logs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
    text:
      description: The raw text of the DHCP log entry.
      type: str
      returned: always
...
def run_module():
    """Runs this info module against /api/v2/status/logs/dhcp."""
    ...
    base_module = base.BaseModule("/api/v2/status/logs/dhcp", client)
    changed = False
