...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_resolver/access_list/network."""
...
DOCUMENTATION = r"""
module: services_dns_resolver_access_list_network
description:
...
EXAMPLES = """
- name: Create DNS Resolver Access List Network
  pfrest.pfsense.services_dns_resolver_access_list_network:
    ...
    network: string
    mask: 1
- name: Delete DNS Resolver Access List Network
  pfrest.pfsense.services_dns_resolver_access_list_network:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
msg:
  ...
  returned: always
data:
  description: The DNS Resolver Access List Network data returned by the API.
  type: dict
  returned: always
  contains:
    network:
...
def run_module():
    """Runs this resource module against /api/v2/services/dns_resolver/access_list/network."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/dns_resolver/access_list/network", client
    )
