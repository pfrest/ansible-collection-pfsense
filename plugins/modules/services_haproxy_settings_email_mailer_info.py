...
description:
- Retrieve information about a single HAProxy Email Mailer.
short_description: Retrieve information about a single HAProxy Email Mailer.
requirements:
...
EXAMPLES = """
- name: Retrieve HAProxy Email Mailer
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/settings/email_mailer."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/haproxy/settings/email_mailer", client
    )
    changed = False
