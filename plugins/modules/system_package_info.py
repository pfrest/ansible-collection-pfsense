...
###############################################################
"""An Ansible module for interacting with /api/v2/system/package."""
...
- name: Retrieve Package
  pfrest.pfsense.system_package_info:
...
msg:
  ...
  returned: always
data:
  description: The Package data returned by the API.
  type: dict
  returned: always
  contains:
    name:
...
def run_module():
    """Runs this info module against /api/v2/system/package."""
    ...
    base_module = base.BaseModule("/api/v2/system/package", client)
    changed = False
