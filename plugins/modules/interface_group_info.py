...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/group."""
...
DOCUMENTATION = r"""
module: interface_group_info
description:
- Retrieve information about a single Interface Group.
short_description: Retrieve information about a single Interface Group.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve Interface Group
  pfrest.pfsense.interface_group_info:
...
msg:
  ...
  returned: always
data:
  description: The Interface Group data returned by the API.
  type: dict
  returned: always
  contains:
    ifname:
...
def run_module():
    """Runs this info module against /api/v2/interface/group."""
    ...
    base_module = base.BaseModule("/api/v2/interface/group", client)
    changed = False
