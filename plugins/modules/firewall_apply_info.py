...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/apply."""
...
DOCUMENTATION = r"""
module: firewall_apply_info
description:
- Retrieve information about the Firewall Apply.
short_description: Retrieve information about the Firewall Apply.
requirements:
...
EXAMPLES = """
- name: Retrieve Firewall Apply
  pfrest.pfsense.firewall_apply_info:
...
def run_module():
    """Runs this info module against /api/v2/firewall/apply."""
    ...
    base_module = base.BaseModule("/api/v2/firewall/apply", client)
    changed = False
