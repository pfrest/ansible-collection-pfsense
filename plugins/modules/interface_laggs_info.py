...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/laggs."""
...
def run_module():
    """Runs this info module against /api/v2/interface/laggs."""
    ...
    base_module = base.BaseModule("/api/v2/interface/laggs", client)
    changed = False
