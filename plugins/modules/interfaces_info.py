...
###############################################################
"""An Ansible module for interacting with /api/v2/interfaces."""
...
def run_module():
    """Runs this info module against /api/v2/interfaces."""
    ...
    base_module = base.BaseModule("/api/v2/interfaces", client)
    changed = False
