...
###############################################################
"""An Ansible module for interacting with /api/v2/auth/jwt."""
...
def run_module():
    """Runs this action module against /api/v2/auth/jwt."""
    ...
    base_module = base.BaseModule("/api/v2/auth/jwt", client)
