...
###############################################################
"""An Ansible module for interacting with /api/v2/system/restapi/settings/sync."""
...
DOCUMENTATION = r"""
module: system_restapi_settings_sync
description:
...
def run_module():
    """Runs this action module against /api/v2/system/restapi/settings/sync."""
    ...
    base_module = base.BaseModule("/api/v2/system/restapi/settings/sync", client)
