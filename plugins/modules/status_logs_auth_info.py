...
###############################################################
"""An Ansible module for interacting with /api/v2/status/logs/auth."""
...
DOCUMENTATION = r"""
module: status_logs_auth_info
description:
- Retrieve information about many Auth Logs.
short_description: Retrieve information about many Auth Logs.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all Auth Logs
  pfrest.pfsense.status_logs_auth_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Auth Logs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
    text:
      description: The raw text of the auth log entry.
      type: str
      returned: always
...
def run_module():
    """Runs this info module against /api/v2/status/logs/auth."""
    ...
    base_module = base.BaseModule("/api/v2/status/logs/auth", client)
    changed = False
