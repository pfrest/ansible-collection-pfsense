...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/frontend/certificates."""
...
DOCUMENTATION = r"""
module: services_haproxy_frontend_certificates_info
description:
- Retrieve information about many HAProxy Frontend Certificateses.
short_description: Retrieve information about many HAProxy Frontend Certificateses.
requirements:
...
EXAMPLES = """
- name: Retrieve all HAProxy Frontend Certificateses
  pfrest.pfsense.services_haproxy_frontend_certificates_info:
...
msg:
  ...
  returned: always
data:
  description: A list of HAProxy Frontend Certificateses returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/frontend/certificates."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/haproxy/frontend/certificates", client
    )
    changed = False
