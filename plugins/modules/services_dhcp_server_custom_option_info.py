...
DOCUMENTATION = r"""
module: services_dhcp_server_custom_option_info
description:
...
EXAMPLES = """
- name: Retrieve DHCP Server Custom Option
  pfrest.pfsense.services_dhcp_server_custom_option_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dhcp_server/custom_option."""
