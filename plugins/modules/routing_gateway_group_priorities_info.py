...
###############################################################
"""An Ansible module for interacting with /api/v2/routing/gateway/group/priorities."""
...
DOCUMENTATION = r"""
module: routing_gateway_group_priorities_info
description:
- Retrieve information about many Routing Gateway Group Priorities.
short_description: Retrieve information about many Routing Gateway Group Priorities.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all Routing Gateway Group Priorities
  pfrest.pfsense.routing_gateway_group_priorities_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Routing Gateway Group Priorities returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/routing/gateway/group/priorities."""
    ...
    base_module = base.BaseModule("/api/v2/routing/gateway/group/priorities", client)
    changed = False
