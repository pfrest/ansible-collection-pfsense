...
DOCUMENTATION = r"""
module: firewall_traffic_shaper_limiter_queue_info
description:
- Retrieve information about a single Traffic Shaper Limiter Queue.
short_description: Retrieve information about a single Traffic Shaper Limiter Queue.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/firewall/traffic_shaper/limiter/queue."""
