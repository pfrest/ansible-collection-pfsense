...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dhcp_server/static_mappings."""
...
DOCUMENTATION = r"""
module: services_dhcp_server_static_mappings_info
description:
- Retrieve information about many DHCP Server Static Mappings.
short_description: Retrieve information about many DHCP Server Static Mappings.
requirements:
...
EXAMPLES = """
- name: Retrieve all DHCP Server Static Mappings
  pfrest.pfsense.services_dhcp_server_static_mappings_info:
...
msg:
  ...
  returned: always
data:
  description: A list of DHCP Server Static Mappings returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/dhcp_server/static_mappings."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/dhcp_server/static_mappings", client
    )
    changed = False
