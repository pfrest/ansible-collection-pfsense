...
###############################################################
"""An Ansible module for interacting with /api/v2/services/acme/settings."""
...
DOCUMENTATION = r"""
module: services_acme_settings
description:
- Manage ACME Settings.
short_description: Manage ACME Settings.
requirements:
...
options:
  ...
  writecerts:
    ...
    default: false
    choices: []
    description: Enables or disables the writing of certificates to /conf/acme/ in
      various formats for use by other scripts or daemons which do not integrate with
      the pfSense certificate manager.
author:
...
EXAMPLES = """
- name: Manage ACME Settings
  pfrest.pfsense.services_acme_settings:
...
def run_module():
    """Runs this singleton module against /api/v2/services/acme/settings."""
    ...
    base_module = base.BaseModule("/api/v2/services/acme/settings", client)
