...
###############################################################
"""An Ansible module for interacting with /api/v2/services/bind/access_list/entry."""
...
DOCUMENTATION = r"""
module: services_bind_access_list_entry
description:
- Manage individual BIND Access List Entries.
short_description: Manage individual BIND Access List Entries.
requirements:
...
options:
  ...
  parent_lookup_query:
    type: dict
    required: true
    description: A dictionary of query parameters used to look up the parent BIND
      Access List. This should contain field name/value pairs that uniquely identify
...
EXAMPLES = """
- name: Create BIND Access List Entry
  pfrest.pfsense.services_bind_access_list_entry:
    ...
    state: present
    value: string
- name: Delete BIND Access List Entry
  pfrest.pfsense.services_bind_access_list_entry:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
msg:
  ...
  returned: always
data:
  description: The BIND Access List Entry data returned by the API.
  type: dict
  returned: always
  contains:
    value:
    ...
    description:
      ...
      returned: always
    parent_id:
      description: The ID of the parent BIND Access List this resource is nested under.
      type: int
      returned: always
...
def run_module():
    """Runs this resource module against /api/v2/services/bind/access_list/entry."""
    ...
    base_module = base.BaseModule("/api/v2/services/bind/access_list/entry", client)
