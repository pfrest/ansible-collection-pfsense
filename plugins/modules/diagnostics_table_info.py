...
###############################################################
"""An Ansible module for interacting with /api/v2/diagnostics/table."""
...
DOCUMENTATION = r"""
module: diagnostics_table_info
description:
- Retrieve information about a single Table.
short_description: Retrieve information about a single Table.
requirements:
...
EXAMPLES = """
- name: Retrieve Table
  pfrest.pfsense.diagnostics_table_info:
...
msg:
  ...
  returned: always
data:
  description: The Table data returned by the API.
  type: dict
  returned: always
  contains:
    entries:
      description: The entries currently in the table.
      type: list
      returned: always
      elements: str
...
def run_module():
    """Runs this info module against /api/v2/diagnostics/table."""
    ...
    base_module = base.BaseModule("/api/v2/diagnostics/table", client)
    changed = False
