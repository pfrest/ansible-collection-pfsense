...
###############################################################
"""An Ansible module for interacting with /api/v2/services/freeradius/interface."""
...
def run_module():
    """Runs this resource module against /api/v2/services/freeradius/interface."""
    ...
    base_module = base.BaseModule("/api/v2/services/freeradius/interface", client)
