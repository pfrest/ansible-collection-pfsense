...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/backend/servers."""
...
DOCUMENTATION = r"""
module: services_haproxy_backend_servers_info
description:
- Retrieve information about many HA Proxy Backend Servers.
short_description: Retrieve information about many HA Proxy Backend Servers.
requirements:
...
EXAMPLES = """
- name: Retrieve all HA Proxy Backend Servers
  pfrest.pfsense.services_haproxy_backend_servers_info:
...
msg:
  ...
  returned: always
data:
  description: A list of HA Proxy Backend Servers returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/backend/servers."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/backend/servers", client)
    changed = False
