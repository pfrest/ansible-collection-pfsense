...
description:
- Retrieve information about many HAProxy Backend Servers.
short_description: Retrieve information about many HAProxy Backend Servers.
requirements:
...
EXAMPLES = """
- name: Retrieve all HAProxy Backend Servers
...
msg:
  ...
  returned: always
data:
  description: A list of HAProxy Backend Servers returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
