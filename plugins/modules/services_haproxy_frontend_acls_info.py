...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/frontend/acls."""
...
DOCUMENTATION = r"""
module: services_haproxy_frontend_acls_info
description:
- Retrieve information about many HAProxy Frontend Access Control Lists.
short_description: Retrieve information about many HAProxy Frontend Access Control
  Lists.
options:
  api_host:
    type: str
...
EXAMPLES = """
- name: Retrieve all HAProxy Frontend Access Control Lists
  pfrest.pfsense.services_haproxy_frontend_acls_info:
...
msg:
  ...
  returned: always
data:
  description: A list of HAProxy Frontend Access Control Lists returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/frontend/acls."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/frontend/acls", client)
    changed = False
