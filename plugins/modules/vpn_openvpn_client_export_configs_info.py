...
description:
- Retrieve information about many OpenVPN Client Export Configs.
short_description: Retrieve information about many OpenVPN Client Export Configs.
requirements:
...
EXAMPLES = """
- name: Retrieve all OpenVPN Client Export Configs
