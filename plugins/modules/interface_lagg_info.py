...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/lagg."""
...
DOCUMENTATION = r"""
module: interface_lagg_info
description:
- Retrieve information about a single Interface LAGG.
short_description: Retrieve information about a single Interface LAGG.
requirements:
...
EXAMPLES = """
- name: Retrieve Interface LAGG
  pfrest.pfsense.interface_lagg_info:
...
msg:
  ...
  returned: always
data:
  description: The Interface LAGG data returned by the API.
  type: dict
  returned: always
  contains:
    laggif:
...
def run_module():
    """Runs this info module against /api/v2/interface/lagg."""
