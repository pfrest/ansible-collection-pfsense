...
options:
  ...
  parent_lookup_fields:
    ...
    elements: str
    required: true
    description: The list of fields to use when looking up the parent DNS Forwarder
      Host Override. This should be a list of field names that uniquely identify the
