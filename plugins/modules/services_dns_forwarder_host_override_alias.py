...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_forwarder/host_override/alias."""
...
DOCUMENTATION = r"""
module: services_dns_forwarder_host_override_alias
description:
- Manage individual DNS Forwarder Host Override Aliases.
short_description: Manage individual DNS Forwarder Host Override Aliases.
options:
  api_host:
    type: str
    required: true
  ...
  parent_lookup_query:
    type: dict
    required: true
    description: A dictionary of query parameters used to look up the parent DNS Forwarder
      Host Override. This should contain field name/value pairs that uniquely identify
...
EXAMPLES = """
- name: Create DNS Forwarder Host Override Alias
  pfrest.pfsense.services_dns_forwarder_host_override_alias:
    ...
    host: string
    domain: string
- name: Delete DNS Forwarder Host Override Alias
  pfrest.pfsense.services_dns_forwarder_host_override_alias:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
data:
  ...
  contains:
    ...
    description:
      ...
      returned: always
    parent_id:
      description: The ID of the parent DNS Forwarder Host Override this resource
        is nested under.
      type: int
      returned: always
...
def run_module():
    """Runs this resource module against /api/v2/services/dns_forwarder/host_override/alias."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/dns_forwarder/host_override/alias", client
    )
