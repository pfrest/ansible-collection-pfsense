...
###############################################################
"""An Ansible module for interacting with /api/v2/routing/apply."""
...
DOCUMENTATION = r"""
module: routing_apply_info
description:
- Retrieve information about the Routing Apply.
short_description: Retrieve information about the Routing Apply.
requirements:
...
EXAMPLES = """
- name: Retrieve Routing Apply
  pfrest.pfsense.routing_apply_info:
...
msg:
  ...
  returned: always
data:
  description: The Routing Apply data returned by the API.
  type: dict
  returned: always
  contains:
    applied:
      description: Displays `true` when all routing changes are applied and there
        are no pending changes left.Displays `false` when there are pending routing
...
def run_module():
    """Runs this info module against /api/v2/routing/apply."""
    ...
    base_module = base.BaseModule("/api/v2/routing/apply", client)
    changed = False
