...
DOCUMENTATION = r"""
module: services_bind_access_list_info
description:
- Retrieve information about a single BIND Access List.
short_description: Retrieve information about a single BIND Access List.
requirements:
...
EXAMPLES = """
- name: Retrieve BIND Access List
  pfrest.pfsense.services_bind_access_list_info:
...
def run_module():
    """Runs this info module against /api/v2/services/bind/access_list."""
