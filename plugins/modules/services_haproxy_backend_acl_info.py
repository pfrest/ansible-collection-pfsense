...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/backend/acl."""
...
DOCUMENTATION = r"""
module: services_haproxy_backend_acl_info
description:
- Retrieve information about a single HAProxy Backend Access Control List.
short_description: Retrieve information about a single HAProxy Backend Access Control
  List.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/backend/acl."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/backend/acl", client)
    changed = False
