...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/ipsec/phase1/encryptions."""
...
DOCUMENTATION = r"""
module: vpn_ipsec_phase1_encryptions_info
description:
- Retrieve information about many IPsec Phase 1 Encryptions.
short_description: Retrieve information about many IPsec Phase 1 Encryptions.
options:
  api_host:
    type: str
    required: true
...
def run_module():
    """Runs this info module against /api/v2/vpn/ipsec/phase1/encryptions."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/ipsec/phase1/encryptions", client)
    changed = False
