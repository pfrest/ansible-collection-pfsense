...
DOCUMENTATION = r"""
module: services_dns_resolver_host_override_alias_info
description:
- Retrieve information about a single DNS Resolver Host Override Alias.
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/host_override/alias."""
