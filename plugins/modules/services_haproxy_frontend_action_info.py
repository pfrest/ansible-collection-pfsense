...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/frontend/action."""
...
DOCUMENTATION = r"""
module: services_haproxy_frontend_action_info
description:
- Retrieve information about a single HA Proxy Frontend Action.
short_description: Retrieve information about a single HA Proxy Frontend Action.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve HA Proxy Frontend Action
  pfrest.pfsense.services_haproxy_frontend_action_info:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/frontend/action."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/frontend/action", client)
    changed = False
