...
description:
- Retrieve information about a single HAProxy Frontend Action.
short_description: Retrieve information about a single HAProxy Frontend Action.
requirements:
...
EXAMPLES = """
- name: Retrieve HAProxy Frontend Action
...
msg:
  ...
  returned: always
data:
  description: The HAProxy Frontend Action data returned by the API.
  type: dict
  returned: always
  contains:
    action:
