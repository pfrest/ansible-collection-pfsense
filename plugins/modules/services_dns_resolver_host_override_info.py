...
DOCUMENTATION = r"""
module: services_dns_resolver_host_override_info
description:
- Retrieve information about a single DNS Resolver Host Override.
short_description: Retrieve information about a single DNS Resolver Host Override.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve DNS Resolver Host Override
  pfrest.pfsense.services_dns_resolver_host_override_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/host_override."""
