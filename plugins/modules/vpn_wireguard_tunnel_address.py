...
DOCUMENTATION = r"""
module: vpn_wireguard_tunnel_address
description:
...
options:
  ...
  parent_lookup_query:
    ...
    description: A dictionary of query parameters used to look up the parent WireGuard
      Tunnel. This should contain field name/value pairs that uniquely identify the
...
data:
  ...
  contains:
    ...
    descr:
      ...
      returned: always
    parent_id:
      description: The ID of the parent WireGuard Tunnel this resource is nested under.
      type: int
      returned: always
...
def run_module():
    """Runs this resource module against /api/v2/vpn/wireguard/tunnel/address."""
