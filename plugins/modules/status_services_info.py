...
###############################################################
"""An Ansible module for interacting with /api/v2/status/services."""
...
DOCUMENTATION = r"""
module: status_services_info
description:
- Retrieve information about many Services.
short_description: Retrieve information about many Services.
requirements:
...
- name: Retrieve all Services
  pfrest.pfsense.status_services_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Services returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/status/services."""
    ...
    base_module = base.BaseModule("/api/v2/status/services", client)
    changed = False
