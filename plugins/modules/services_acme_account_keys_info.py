...
###############################################################
"""An Ansible module for interacting with /api/v2/services/acme/account_keys."""
...
DOCUMENTATION = r"""
module: services_acme_account_keys_info
description:
- Retrieve information about many ACME Account Keys.
short_description: Retrieve information about many ACME Account Keys.
requirements:
...
EXAMPLES = """
- name: Retrieve all ACME Account Keys
  pfrest.pfsense.services_acme_account_keys_info:
...
def run_module():
    """Runs this info module against /api/v2/services/acme/account_keys."""
