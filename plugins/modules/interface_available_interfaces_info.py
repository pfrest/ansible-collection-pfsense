...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/available_interfaces."""
...
DOCUMENTATION = r"""
module: interface_available_interfaces_info
description:
...
def run_module():
    """Runs this info module against /api/v2/interface/available_interfaces."""
    ...
    base_module = base.BaseModule("/api/v2/interface/available_interfaces", client)
    changed = False
