...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/settings/dns_resolver."""
...
DOCUMENTATION = r"""
module: services_haproxy_settings_dns_resolver
description:
- Manage individual HAProxy DNS Resolvers.
short_description: Manage individual HAProxy DNS Resolvers.
requirements:
...
options:
  ...
  port:
    ...
    default: '53'
    choices: []
    description: 'The port used by this DNS server. Valid options are: a TCP/UDP port
      number'
author:
...
EXAMPLES = """
- name: Create HAProxy DNS Resolver
  pfrest.pfsense.services_haproxy_settings_dns_resolver:
    ...
    name: string
    server: string
- name: Delete HAProxy DNS Resolver
  pfrest.pfsense.services_haproxy_settings_dns_resolver:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
msg:
  ...
  returned: always
data:
  description: The HAProxy DNS Resolver data returned by the API.
  type: dict
  returned: always
  contains:
    name:
...
def run_module():
    """Runs this resource module against /api/v2/services/haproxy/settings/dns_resolver."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/haproxy/settings/dns_resolver", client
    )
