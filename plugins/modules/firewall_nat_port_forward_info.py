...
DOCUMENTATION = r"""
module: firewall_nat_port_forward_info
description:
- Retrieve information about a single Port Forward.
short_description: Retrieve information about a single Port Forward.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve Port Forward
  pfrest.pfsense.firewall_nat_port_forward_info:
...
def run_module():
    """Runs this info module against /api/v2/firewall/nat/port_forward."""
