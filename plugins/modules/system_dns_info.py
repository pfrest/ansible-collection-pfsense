...
###############################################################
"""An Ansible module for interacting with /api/v2/system/dns."""
...
def run_module():
    """Runs this info module against /api/v2/system/dns."""
    ...
    base_module = base.BaseModule("/api/v2/system/dns", client)
    changed = False
