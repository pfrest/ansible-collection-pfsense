...
###############################################################
"""An Ansible module for interacting with /api/v2/services/bind/access_lists."""
...
DOCUMENTATION = r"""
module: services_bind_access_lists_info
description:
- Retrieve information about many BIND Access Lists.
short_description: Retrieve information about many BIND Access Lists.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all BIND Access Lists
  pfrest.pfsense.services_bind_access_lists_info:
...
msg:
  ...
  returned: always
data:
  description: A list of BIND Access Lists returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/bind/access_lists."""
    ...
    base_module = base.BaseModule("/api/v2/services/bind/access_lists", client)
    changed = False
