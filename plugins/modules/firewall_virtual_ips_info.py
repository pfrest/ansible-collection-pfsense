...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/virtual_ips."""
...
def run_module():
    """Runs this info module against /api/v2/firewall/virtual_ips."""
    ...
    base_module = base.BaseModule("/api/v2/firewall/virtual_ips", client)
    changed = False
