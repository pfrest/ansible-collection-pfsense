...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/ipsec/phase2/encryptions."""
...
DOCUMENTATION = r"""
module: vpn_ipsec_phase2_encryptions_info
description:
...
EXAMPLES = """
- name: Retrieve all IPsec Phase 2 Encryptions
  pfrest.pfsense.vpn_ipsec_phase2_encryptions_info:
...
msg:
  ...
  returned: always
data:
  description: A list of IPsec Phase 2 Encryptions returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/vpn/ipsec/phase2/encryptions."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/ipsec/phase2/encryptions", client)
    changed = False
