...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/traffic_shaper/limiter/bandwidth."""
...
DOCUMENTATION = r"""
module: firewall_traffic_shaper_limiter_bandwidth
description:
...
EXAMPLES = """
- name: Create Traffic Shaper Limiter Bandwidth
  pfrest.pfsense.firewall_traffic_shaper_limiter_bandwidth:
    ...
    bw: 1
    bwscale: b
- name: Delete Traffic Shaper Limiter Bandwidth
  pfrest.pfsense.firewall_traffic_shaper_limiter_bandwidth:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
msg:
  ...
  returned: always
data:
  description: The Traffic Shaper Limiter Bandwidth data returned by the API.
  type: dict
  returned: always
  contains:
    bw:
...
def run_module():
    """Runs this resource module against /api/v2/firewall/traffic_shaper/limiter/bandwidth."""
    ...
    base_module = base.BaseModule(
        "/api/v2/firewall/traffic_shaper/limiter/bandwidth", client
    )
