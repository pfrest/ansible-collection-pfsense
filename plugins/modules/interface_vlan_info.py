...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/vlan."""
...
def run_module():
    """Runs this info module against /api/v2/interface/vlan."""
    ...
    base_module = base.BaseModule("/api/v2/interface/vlan", client)
    changed = False
