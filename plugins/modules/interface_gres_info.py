...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/gres."""
...
DOCUMENTATION = r"""
module: interface_gres_info
description:
- Retrieve information about many Interface GREs.
short_description: Retrieve information about many Interface GREs.
requirements:
...
EXAMPLES = """
- name: Retrieve all Interface GREs
  pfrest.pfsense.interface_gres_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Interface GREs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/interface/gres."""
    ...
    base_module = base.BaseModule("/api/v2/interface/gres", client)
    changed = False
