...
description:
- Retrieve information about a single HAProxy Frontend Error File.
short_description: Retrieve information about a single HAProxy Frontend Error File.
requirements:
...
EXAMPLES = """
- name: Retrieve HAProxy Frontend Error File
