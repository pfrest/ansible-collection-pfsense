...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/wireguard/peer/allowed_ips."""
...
DOCUMENTATION = r"""
module: vpn_wireguard_peer_allowed_ips_info
description:
- Retrieve information about many WireGuard Peer Allowed IPs.
short_description: Retrieve information about many WireGuard Peer Allowed IPs.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all WireGuard Peer Allowed IPs
  pfrest.pfsense.vpn_wireguard_peer_allowed_ips_info:
...
msg:
  ...
  returned: always
data:
  description: A list of WireGuard Peer Allowed IPs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/vpn/wireguard/peer/allowed_ips."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/wireguard/peer/allowed_ips", client)
    changed = False
