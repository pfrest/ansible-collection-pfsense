...
DOCUMENTATION = r"""
module: services_dns_resolver_access_list_info
description:
- Retrieve information about a single DNS Resolver Access List.
short_description: Retrieve information about a single DNS Resolver Access List.
requirements:
...
EXAMPLES = """
- name: Retrieve DNS Resolver Access List
  pfrest.pfsense.services_dns_resolver_access_list_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/access_list."""
