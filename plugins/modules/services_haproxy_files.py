...
def run_module():
    module_args = {
        ...
        "objects": {
            ...
            "choices": [],
            "elements": "dict",
            "suboptions": {'name': {'required': True, 'type': 'str', 'default': None, 'choices': [], 'description': 'The unique name for this file.'}, 'type': {'required': False, 'type': 'str', 'default': None, 'choices': ['luascript', 'writetodisk'], 'description': 'The type of file. Use `null` to assume an Errorfile.'}, 'content': {'required': True, 'type': 'str', 'default': None, 'choices': [], 'description': 'The content of this file.'}},
        },
    }
