...
short_description: Manage all IPsec Phase 2s.
options:
  api_host:
    type: str
    required: true
  ...
  objects:
    ...
    suboptions:
      ...
      pfsgroup:
        ...
        - 31
        - 32
        description: 'The PFS key group this IPsec phase 2 entry should use. Note:
          Groups 1, 2, 5, 22, 23, and 24 provide weak security and should be avoided.'
      rekey_time:
        required: false
        type: int
        default: 3240
        choices: []
        description: The amount of time (in seconds) before an IKE SA establishes
          new keys.
      rand_time:
        required: false
        type: int
        ...
        description: A random value up to this amount will be subtracted from the
          `rekey_time` and `reauth_time` to avoid simultaneous renegotiation.
      lifetime:
        required: false
        type: int
        default: 3600
        choices: []
        description: The hard IKE SA lifetime (in seconds) after which the IKE SA
          will be expired.
      pinghost:
        required: false
        type: str
      ...
      keepalive:
        ...
        description: Enables or disables checking this P2 and initiating if disconnected;
          ...
          'Child SA Start Action' and works for both VTI and tunnel mode P2s. For
          IKEv2 without split connections, this only needs to be enabled on one P2.
