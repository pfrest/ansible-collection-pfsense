...
DOCUMENTATION = r"""
module: services_dns_resolver_access_lists_info
description:
- Retrieve information about many DNS Resolver Access Lists.
short_description: Retrieve information about many DNS Resolver Access Lists.
requirements:
...
EXAMPLES = """
- name: Retrieve all DNS Resolver Access Lists
  pfrest.pfsense.services_dns_resolver_access_lists_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/access_lists."""
