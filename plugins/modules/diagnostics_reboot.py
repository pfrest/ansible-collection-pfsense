...
###############################################################
"""An Ansible module for interacting with /api/v2/diagnostics/reboot."""
...
DOCUMENTATION = r"""
module: diagnostics_reboot
description:
- Perform the System Reboot action.
short_description: Perform the System Reboot action.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Perform System Reboot action
  pfrest.pfsense.diagnostics_reboot:
...
msg:
  ...
  returned: always
data:
  description: The System Reboot data returned by the API.
  type: dict
  returned: always
...
def run_module():
    """Runs this action module against /api/v2/diagnostics/reboot."""
    ...
    base_module = base.BaseModule("/api/v2/diagnostics/reboot", client)
