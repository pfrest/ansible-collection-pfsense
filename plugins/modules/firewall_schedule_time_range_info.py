...
DOCUMENTATION = r"""
module: firewall_schedule_time_range_info
description:
- Retrieve information about a single Firewall Schedule Time Range.
short_description: Retrieve information about a single Firewall Schedule Time Range.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve Firewall Schedule Time Range
  pfrest.pfsense.firewall_schedule_time_range_info:
...
def run_module():
    """Runs this info module against /api/v2/firewall/schedule/time_range."""
