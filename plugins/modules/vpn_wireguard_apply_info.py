...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/wireguard/apply."""
...
DOCUMENTATION = r"""
module: vpn_wireguard_apply_info
description:
- Retrieve information about the Wire Guard Apply.
short_description: Retrieve information about the Wire Guard Apply.
requirements:
...
EXAMPLES = """
- name: Retrieve Wire Guard Apply
  pfrest.pfsense.vpn_wireguard_apply_info:
...
data:
  ...
  contains:
    applied:
      description: Displays `true` when all WireGuard changes are applied and there
        are no pending changes left.Displays `false` when there are pending WireGuard
...
def run_module():
    """Runs this info module against /api/v2/vpn/wireguard/apply."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/wireguard/apply", client)
    changed = False
