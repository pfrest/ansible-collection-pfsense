...
###############################################################
"""An Ansible module for interacting with /api/v2/system/certificate/renew."""
...
DOCUMENTATION = r"""
module: system_certificate_renew
description:
- Perform the Certificate Renew action.
short_description: Perform the Certificate Renew action.
options:
  api_host:
    type: str
    required: true
...
def run_module():
    """Runs this action module against /api/v2/system/certificate/renew."""
    ...
    base_module = base.BaseModule("/api/v2/system/certificate/renew", client)
