...
###############################################################
"""An Ansible module for interacting with /api/v2/services/bind/sync/settings."""
...
DOCUMENTATION = r"""
module: services_bind_sync_settings_info
description:
- Retrieve information about the BIND Sync Settings.
short_description: Retrieve information about the BIND Sync Settings.
requirements:
...
EXAMPLES = """
- name: Retrieve BIND Sync Settings
  pfrest.pfsense.services_bind_sync_settings_info:
...
def run_module():
    """Runs this info module against /api/v2/services/bind/sync/settings."""
    ...
    base_module = base.BaseModule("/api/v2/services/bind/sync/settings", client)
    changed = False
