...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/settings/dns_resolvers."""
...
EXAMPLES = """
- name: Retrieve all HA Proxy DNS Resolvers
  pfrest.pfsense.services_haproxy_settings_dns_resolvers_info:
...
msg:
  ...
  returned: always
data:
  description: A list of HA Proxy DNS Resolvers returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/settings/dns_resolvers."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/haproxy/settings/dns_resolvers", client
    )
    changed = False
