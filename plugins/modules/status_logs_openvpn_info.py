...
description:
- Retrieve information about many OpenVPN Logs.
short_description: Retrieve information about many OpenVPN Logs.
requirements:
...
EXAMPLES = """
- name: Retrieve all OpenVPN Logs
...
msg:
  ...
  returned: always
data:
  description: A list of OpenVPN Logs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
