...
###############################################################
"""An Ansible module for interacting with /api/v2/status/logs/openvpn."""
...
DOCUMENTATION = r"""
module: status_logs_openvpn_info
description:
- Retrieve information about many Open VPN Logs.
short_description: Retrieve information about many Open VPN Logs.
requirements:
...
EXAMPLES = """
- name: Retrieve all Open VPN Logs
  pfrest.pfsense.status_logs_openvpn_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Open VPN Logs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
    text:
      description: The raw text of the openvpn log entry.
      type: str
      returned: always
...
def run_module():
    """Runs this info module against /api/v2/status/logs/openvpn."""
    ...
    base_module = base.BaseModule("/api/v2/status/logs/openvpn", client)
    changed = False
