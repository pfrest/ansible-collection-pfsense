...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/vlans."""
...
EXAMPLES = """
- name: Retrieve all Interface VLANs
  pfrest.pfsense.interface_vlans_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Interface VLANs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/interface/vlans."""
    ...
    base_module = base.BaseModule("/api/v2/interface/vlans", client)
    changed = False
