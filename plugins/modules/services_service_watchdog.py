...
###############################################################
"""An Ansible module for interacting with /api/v2/services/service_watchdog."""
...
DOCUMENTATION = r"""
module: services_service_watchdog
description:
- Manage individual Service Watchdogs.
short_description: Manage individual Service Watchdogs.
options:
  api_host:
    type: str
    required: true
...
- name: Create Service Watchdog
  pfrest.pfsense.services_service_watchdog:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
    state: present
    name: string
- name: Delete Service Watchdog
  pfrest.pfsense.services_service_watchdog:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
def run_module():
    """Runs this resource module against /api/v2/services/service_watchdog."""
    ...
    base_module = base.BaseModule("/api/v2/services/service_watchdog", client)
