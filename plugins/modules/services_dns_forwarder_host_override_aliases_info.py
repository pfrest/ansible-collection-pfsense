...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_forwarder/host_override/aliases."""
...
DOCUMENTATION = r"""
module: services_dns_forwarder_host_override_aliases_info
description:
- Retrieve information about many DNS Forwarder Host Override Aliases.
short_description: Retrieve information about many DNS Forwarder Host Override Aliases.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all DNS Forwarder Host Override Aliases
  pfrest.pfsense.services_dns_forwarder_host_override_aliases_info:
...
msg:
  ...
  returned: always
data:
  description: A list of DNS Forwarder Host Override Aliases returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_forwarder/host_override/aliases."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/dns_forwarder/host_override/aliases", client
    )
    changed = False
