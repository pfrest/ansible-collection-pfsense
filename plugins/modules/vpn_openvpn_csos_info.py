...
description:
- Retrieve information about many Open VPN Client Specific Overrides.
short_description: Retrieve information about many Open VPN Client Specific Overrides.
options:
  api_host:
    type: str
    required: true
