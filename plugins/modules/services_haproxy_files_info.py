...
DOCUMENTATION = r"""
module: services_haproxy_files_info
description:
- Retrieve information about many HA Proxy Files.
short_description: Retrieve information about many HA Proxy Files.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all HA Proxy Files
  pfrest.pfsense.services_haproxy_files_info:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/files."""
