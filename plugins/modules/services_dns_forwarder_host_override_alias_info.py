...
DOCUMENTATION = r"""
module: services_dns_forwarder_host_override_alias_info
description:
- Retrieve information about a single DNS Forwarder Host Override Alias.
...
def run_module():
    """Runs this info module against /api/v2/services/dns_forwarder/host_override/alias."""
