...
DOCUMENTATION = r"""
module: services_dhcp_server_apply
description:
- Perform the DHCP Server Apply action.
short_description: Perform the DHCP Server Apply action.
requirements:
...
def run_module():
    """Runs this action module against /api/v2/services/dhcp_server/apply."""
