...
###############################################################
"""An Ansible module for interacting with /api/v2/status/logs/firewall."""
...
DOCUMENTATION = r"""
module: status_logs_firewall_info
description:
- Retrieve information about many Firewall Logs.
short_description: Retrieve information about many Firewall Logs.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all Firewall Logs
  pfrest.pfsense.status_logs_firewall_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Firewall Logs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
    text:
      description: The raw text of the firewall log entry.
      type: str
      returned: always
...
def run_module():
    """Runs this info module against /api/v2/status/logs/firewall."""
    ...
    base_module = base.BaseModule("/api/v2/status/logs/firewall", client)
    changed = False
