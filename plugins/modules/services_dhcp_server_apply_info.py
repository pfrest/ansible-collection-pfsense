...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dhcp_server/apply."""
...
DOCUMENTATION = r"""
module: services_dhcp_server_apply_info
description:
- Retrieve information about the DHCP Server Apply.
short_description: Retrieve information about the DHCP Server Apply.
requirements:
...
EXAMPLES = """
- name: Retrieve DHCP Server Apply
  pfrest.pfsense.services_dhcp_server_apply_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dhcp_server/apply."""
    ...
    base_module = base.BaseModule("/api/v2/services/dhcp_server/apply", client)
    changed = False
