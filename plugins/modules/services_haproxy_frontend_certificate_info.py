...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/frontend/certificate."""
...
DOCUMENTATION = r"""
module: services_haproxy_frontend_certificate_info
description:
...
EXAMPLES = """
- name: Retrieve HAProxy Frontend Certificates
  pfrest.pfsense.services_haproxy_frontend_certificate_info:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/frontend/certificate."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/haproxy/frontend/certificate", client
    )
    changed = False
