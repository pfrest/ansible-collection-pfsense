...
###############################################################
"""An Ansible module for interacting with /api/v2/diagnostics/config_history/revision."""
...
DOCUMENTATION = r"""
module: diagnostics_config_history_revision_info
description:
- Retrieve information about a single Configuration History Entry.
short_description: Retrieve information about a single Configuration History Entry.
requirements:
...
def run_module():
    """Runs this info module against /api/v2/diagnostics/config_history/revision."""
    ...
    base_module = base.BaseModule("/api/v2/diagnostics/config_history/revision", client)
    changed = False
