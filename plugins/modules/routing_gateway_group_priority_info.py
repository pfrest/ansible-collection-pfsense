...
###############################################################
"""An Ansible module for interacting with /api/v2/routing/gateway/group/priority."""
...
DOCUMENTATION = r"""
module: routing_gateway_group_priority_info
description:
- Retrieve information about a single Routing Gateway Group Priority.
short_description: Retrieve information about a single Routing Gateway Group Priority.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve Routing Gateway Group Priority
  pfrest.pfsense.routing_gateway_group_priority_info:
...
def run_module():
    """Runs this info module against /api/v2/routing/gateway/group/priority."""
    ...
    base_module = base.BaseModule("/api/v2/routing/gateway/group/priority", client)
    changed = False
