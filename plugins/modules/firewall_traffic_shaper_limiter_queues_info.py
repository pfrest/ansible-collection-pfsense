...
###############################################################
"""An Ansible module for interacting with /api/v2/firewall/traffic_shaper/limiter/queues."""
...
DOCUMENTATION = r"""
module: firewall_traffic_shaper_limiter_queues_info
description:
- Retrieve information about many Traffic Shaper Limiter Queues.
short_description: Retrieve information about many Traffic Shaper Limiter Queues.
requirements:
...
EXAMPLES = """
- name: Retrieve all Traffic Shaper Limiter Queues
  pfrest.pfsense.firewall_traffic_shaper_limiter_queues_info:
...
msg:
  ...
  returned: always
data:
  description: A list of Traffic Shaper Limiter Queues returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/firewall/traffic_shaper/limiter/queues."""
    ...
    base_module = base.BaseModule(
        "/api/v2/firewall/traffic_shaper/limiter/queues", client
    )
    changed = False
