...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/apply."""
...
DOCUMENTATION = r"""
module: interface_apply_info
description:
- Retrieve information about the Interface Apply.
short_description: Retrieve information about the Interface Apply.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve Interface Apply
  pfrest.pfsense.interface_apply_info:
...
msg:
  ...
  returned: always
data:
  description: The Interface Apply data returned by the API.
  type: dict
  returned: always
  contains:
    applied:
      description: Displays `true` when all interfaces are applied and there are no
        pending changes left.Displays `false` when there are pending interface changes
        that have not been applied.
      type: bool
      returned: always
    pending_interfaces:
      description: Displays a list of interfaces that have pending changes waiting
        to be applied.
      type: list
      returned: always
      elements: str
...
def run_module():
    """Runs this info module against /api/v2/interface/apply."""
    ...
    base_module = base.BaseModule("/api/v2/interface/apply", client)
    changed = False
