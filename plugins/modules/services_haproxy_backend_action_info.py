...
###############################################################
"""An Ansible module for interacting with /api/v2/services/haproxy/backend/action."""
...
DOCUMENTATION = r"""
module: services_haproxy_backend_action_info
description:
- Retrieve information about a single HA Proxy Backend Action.
short_description: Retrieve information about a single HA Proxy Backend Action.
requirements:
...
EXAMPLES = """
- name: Retrieve HA Proxy Backend Action
  pfrest.pfsense.services_haproxy_backend_action_info:
...
def run_module():
    """Runs this info module against /api/v2/services/haproxy/backend/action."""
    ...
    base_module = base.BaseModule("/api/v2/services/haproxy/backend/action", client)
    changed = False
