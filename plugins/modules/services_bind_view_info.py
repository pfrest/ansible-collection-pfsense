...
###############################################################
"""An Ansible module for interacting with /api/v2/services/bind/view."""
...
DOCUMENTATION = r"""
module: services_bind_view_info
description:
- Retrieve information about a single BIND View.
short_description: Retrieve information about a single BIND View.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve BIND View
  pfrest.pfsense.services_bind_view_info:
...
msg:
  ...
  returned: always
data:
  description: The BIND View data returned by the API.
  type: dict
  returned: always
  contains:
    name:
...
def run_module():
    """Runs this info module against /api/v2/services/bind/view."""
    ...
    base_module = base.BaseModule("/api/v2/services/bind/view", client)
    changed = False
