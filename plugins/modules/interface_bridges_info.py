...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/bridges."""
...
def run_module():
    """Runs this info module against /api/v2/interface/bridges."""
    ...
    base_module = base.BaseModule("/api/v2/interface/bridges", client)
    changed = False
