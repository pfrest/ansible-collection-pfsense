...
###############################################################
"""An Ansible module for interacting with /api/v2/status/logs/system."""
...
DOCUMENTATION = r"""
module: status_logs_system_info
description:
...
EXAMPLES = """
- name: Retrieve all System Logs
  pfrest.pfsense.status_logs_system_info:
...
msg:
  ...
  returned: always
data:
  description: A list of System Logs returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
    text:
      description: The raw text of the system log entry.
      type: str
      returned: always
...
def run_module():
    """Runs this info module against /api/v2/status/logs/system."""
    ...
    base_module = base.BaseModule("/api/v2/status/logs/system", client)
    changed = False
