...
###############################################################
"""An Ansible module for interacting with /api/v2/services/acme/account_key/registrations."""
...
DOCUMENTATION = r"""
module: services_acme_account_key_registrations_info
description:
- Retrieve information about many ACME Account Key Registrations.
short_description: Retrieve information about many ACME Account Key Registrations.
requirements:
...
EXAMPLES = """
- name: Retrieve all ACME Account Key Registrations
  pfrest.pfsense.services_acme_account_key_registrations_info:
...
msg:
  ...
  returned: always
data:
  description: A list of ACME Account Key Registrations returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/services/acme/account_key/registrations."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/acme/account_key/registrations", client
    )
    changed = False
