...
###############################################################
"""An Ansible module for interacting with /api/v2/status/carp."""
...
EXAMPLES = """
- name: Retrieve CARP
  pfrest.pfsense.status_carp_info:
...
def run_module():
    """Runs this info module against /api/v2/status/carp."""
    ...
    base_module = base.BaseModule("/api/v2/status/carp", client)
    changed = False
