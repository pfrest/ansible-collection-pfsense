...
###############################################################
"""An Ansible module for interacting with /api/v2/status/openvpn/server/route."""
...
DOCUMENTATION = r"""
module: status_openvpn_server_route_info
description:
- Retrieve information about a single OpenVPN Server Route Status.
short_description: Retrieve information about a single OpenVPN Server Route Status.
options:
  api_host:
    type: str
    required: true
...
def run_module():
    """Runs this info module against /api/v2/status/openvpn/server/route."""
    ...
    base_module = base.BaseModule("/api/v2/status/openvpn/server/route", client)
    changed = False
