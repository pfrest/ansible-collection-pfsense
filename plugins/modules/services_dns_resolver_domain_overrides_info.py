...
DOCUMENTATION = r"""
module: services_dns_resolver_domain_overrides_info
description:
- Retrieve information about many DNS Resolver Domain Overrides.
short_description: Retrieve information about many DNS Resolver Domain Overrides.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all DNS Resolver Domain Overrides
  pfrest.pfsense.services_dns_resolver_domain_overrides_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/domain_overrides."""
