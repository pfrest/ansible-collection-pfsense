...
DOCUMENTATION = r"""
module: vpn_ipsec_phase1_encryption_info
description:
- Retrieve information about a single IPsec Phase 1 Encryption.
short_description: Retrieve information about a single IPsec Phase 1 Encryption.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve IPsec Phase 1 Encryption
  pfrest.pfsense.vpn_ipsec_phase1_encryption_info:
...
def run_module():
    """Runs this info module against /api/v2/vpn/ipsec/phase1/encryption."""
