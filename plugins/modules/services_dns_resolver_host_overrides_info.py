...
###############################################################
"""An Ansible module for interacting with /api/v2/services/dns_resolver/host_overrides."""
...
DOCUMENTATION = r"""
module: services_dns_resolver_host_overrides_info
description:
- Retrieve information about many DNS Resolver Host Overrides.
short_description: Retrieve information about many DNS Resolver Host Overrides.
requirements:
...
EXAMPLES = """
- name: Retrieve all DNS Resolver Host Overrides
  pfrest.pfsense.services_dns_resolver_host_overrides_info:
...
def run_module():
    """Runs this info module against /api/v2/services/dns_resolver/host_overrides."""
    ...
    base_module = base.BaseModule(
        "/api/v2/services/dns_resolver/host_overrides", client
    )
    changed = False
