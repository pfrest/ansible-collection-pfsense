...
DOCUMENTATION = r"""
module: routing_gateway_group_info
description:
- Retrieve information about a single Routing Gateway Group.
short_description: Retrieve information about a single Routing Gateway Group.
requirements:
...
EXAMPLES = """
- name: Retrieve Routing Gateway Group
  pfrest.pfsense.routing_gateway_group_info:
...
def run_module():
    """Runs this info module against /api/v2/routing/gateway/group."""
