...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/wireguard/peer/allowed_ip."""
...
DOCUMENTATION = r"""
module: vpn_wireguard_peer_allowed_ip
description:
- Manage individual WireGuard Peer Allowed IPs.
short_description: Manage individual WireGuard Peer Allowed IPs.
requirements:
...
options:
  ...
  parent_lookup_query:
    type: dict
    required: true
    description: A dictionary of query parameters used to look up the parent WireGuard
      Peer. This should contain field name/value pairs that uniquely identify the
...
def run_module():
    """Runs this resource module against /api/v2/vpn/wireguard/peer/allowed_ip."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/wireguard/peer/allowed_ip", client)
