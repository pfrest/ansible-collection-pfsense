...
###############################################################
"""An Ansible module for interacting with /api/v2/system/restapi/access_list/entry."""
...
def run_module():
    """Runs this resource module against /api/v2/system/restapi/access_list/entry."""
    ...
    base_module = base.BaseModule("/api/v2/system/restapi/access_list/entry", client)
