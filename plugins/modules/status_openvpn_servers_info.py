...
###############################################################
"""An Ansible module for interacting with /api/v2/status/openvpn/servers."""
...
def run_module():
    """Runs this info module against /api/v2/status/openvpn/servers."""
    ...
    base_module = base.BaseModule("/api/v2/status/openvpn/servers", client)
    changed = False
