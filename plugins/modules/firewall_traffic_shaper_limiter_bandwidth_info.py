...
DOCUMENTATION = r"""
module: firewall_traffic_shaper_limiter_bandwidth_info
description:
...
EXAMPLES = """
- name: Retrieve Traffic Shaper Limiter Bandwidth
  pfrest.pfsense.firewall_traffic_shaper_limiter_bandwidth_info:
...
def run_module():
    """Runs this info module against /api/v2/firewall/traffic_shaper/limiter/bandwidth."""
