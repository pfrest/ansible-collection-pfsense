...
DOCUMENTATION = r"""
module: services_dns_resolver_domain_override
description:
- Manage individual DNS Resolver Domain Overrides.
short_description: Manage individual DNS Resolver Domain Overrides.
requirements:
...
options:
  ...
  forward_tls_upstream:
    ...
    default: false
    choices: []
    description: Enables or disables forwarding DNS queries to the upstream DNS server
      using TLS.
  tls_hostname:
    required: false
    type: str
...
EXAMPLES = """
- name: Create DNS Resolver Domain Override
  pfrest.pfsense.services_dns_resolver_domain_override:
    ...
    domain: string
    ip: string
- name: Delete DNS Resolver Domain Override
  pfrest.pfsense.services_dns_resolver_domain_override:
    api_host: pfsense.example.com
    api_username: admin
    api_password: pfsense
...
def run_module():
    """Runs this resource module against /api/v2/services/dns_resolver/domain_override."""
