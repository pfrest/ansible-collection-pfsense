...
###############################################################
"""An Ansible module for interacting with /api/v2/vpn/wireguard/tunnel/addresses."""
...
DOCUMENTATION = r"""
module: vpn_wireguard_tunnel_addresses_info
description:
- Retrieve information about many WireGuard Tunnel Addresses.
short_description: Retrieve information about many WireGuard Tunnel Addresses.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all WireGuard Tunnel Addresses
  pfrest.pfsense.vpn_wireguard_tunnel_addresses_info:
...
msg:
  ...
  returned: always
data:
  description: A list of WireGuard Tunnel Addresses returned by the API.
  type: list
  elements: dict
  returned: always
  contains:
...
def run_module():
    """Runs this info module against /api/v2/vpn/wireguard/tunnel/addresses."""
    ...
    base_module = base.BaseModule("/api/v2/vpn/wireguard/tunnel/addresses", client)
    changed = False
