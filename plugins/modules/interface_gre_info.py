...
###############################################################
"""An Ansible module for interacting with /api/v2/interface/gre."""
...
def run_module():
    """Runs this info module against /api/v2/interface/gre."""
    ...
    base_module = base.BaseModule("/api/v2/interface/gre", client)
    changed = False
