...
DOCUMENTATION = r"""
module: vpn_wireguard_peers_info
description:
- Retrieve information about many WireGuard Peers.
short_description: Retrieve information about many WireGuard Peers.
options:
  api_host:
    type: str
    required: true
...
EXAMPLES = """
- name: Retrieve all WireGuard Peers
  pfrest.pfsense.vpn_wireguard_peers_info:
...
def run_module():
    """Runs this info module against /api/v2/vpn/wireguard/peers."""
